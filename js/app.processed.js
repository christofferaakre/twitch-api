...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _StreamsList = __webpack_require__(328);
	...
	var names = ["freecodecamp", "OgamingSC2", "esl_sc2", "noobs2ninjas"];
	...
	var App = exports.App = function (_React$Component) {
	  ...
	  function App() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      ...
	      var search = _this.state.search.toLowerCase();
	      var matches = {};
	      Object.keys(channels).forEach(function (channel) {
	        if (channel.toLowerCase().startsWith(search) || channels[channel].stream && channels[channel].stream.channel.display_name.toLowerCase().startsWith(search)) {
	          matches = _extends({}, matches, _defineProperty({}, channel, channels[channel]));
	        }
	      });
	      return matches;
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      names.forEach(function (channel) {
	        var streamsURL = api + "/streams/" + channel;
	        var usersURL = api + "/users/" + channel;
	        fetch(streamsURL).then(function (response) {
	          return response.json().then(function (stream) {
	            _this2.setState(function (_ref2) {
	              var channels = _ref2.channels;
	              return {
	                channels: _extends({}, channels, _defineProperty({}, channel, stream))
	              };
	            });
	            fetch(usersURL).then(function (response) {
	              return response.json().then(function (user) {
	                return _this2.setState(function (_ref3) {
	                  ...
	                  return {
	                    channels: _extends({}, channels, _defineProperty({}, channel, _extends({}, channels[channel], { name: user.display_name })))
	                  };
	                });
	              });
	            });
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(_StreamsList2.default, { channels: this.filterChannels(channels) })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.StreamsList = undefined;

	var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

	var _Stream = __webpack_require__(329);

	var _Stream2 = _interopRequireDefault(_Stream);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var StreamsList = exports.StreamsList = function StreamsList(_ref) {
	  ...
	  return React.createElement(
	    ...
	    Object.keys(channels).map(function (channel) {
	      return React.createElement(
	        "li",
	        { key: channel },
	        React.createElement(_Stream2.default, _extends({ online: !!channels[channel].stream }, channels[channel]))
	      );
	    })
	  );
	};

		exports.default = StreamsList;
...
/***/ (function(module, exports) {
	...
	var Stream = exports.Stream = function Stream(_ref) {
	  var _links = _ref._links,
	      stream = _ref.stream,
	      name = _ref.name;
	  return React.createElement(
	    "a",
	    { href: stream ? stream.channel.url : '#',
	      target: "__blank" },
	    React.createElement(
	      "article",
	      { "class": "stream" },
	      ...
	      " ",
	      stream && stream.game && React.createElement(
	        "small",
	        null,
	        " ",
	        stream.game,
	      ...
	      stream ? React.createElement(
	        "div",
	        { "class": "stream-info" },
	        React.createElement("img", { "class": "preview",
